	 ...
	 * @param {Object} value
	 */
	function showOfflineStrategy(value){
		var timeVal = value.split('|');
		if(timeVal[0]==null || timeVal[0] ==""){
			return timeVal[1]+"-"+timeVal[2];
		}
		if (timeVal[1] == null || timeVal[1] == "") {
			return timeVal[0]+'小时';
		}
		return timeVal[0]+'小时'+timeVal[1]+"-"+timeVal[2];
	}
